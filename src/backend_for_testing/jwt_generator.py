...
class JWTGenerator:
    def __init__(self):
        file_path_private_key = os.path.join(os.path.dirname(
            os.path.abspath(__file__)), "test_private_key.pem")
...
if __name__ == "__main__":
    ...
    print(JWTGenerator().generate_jwt_token(iat=iat, exp=iat + 5000,
